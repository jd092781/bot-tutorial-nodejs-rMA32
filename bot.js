...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.end();
                ...
                else if(request.text && botpaulywindow.test(request.text)) {
    this.res.writeHead(200);
