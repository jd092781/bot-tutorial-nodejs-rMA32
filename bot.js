...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.end();
          ...
          else if(request.text && botlaugh.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://i.groupme.com/360x273.gif.acbd3858491747efb4b0444d8fa96561.large");
    this.res.end();
  }
    ...
    this.res.end();
      ...
      else if(request.text && botwtf.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://i.groupme.com/320x289.gif.ac0cac993d774d6194421d7fc390cc7f.large");
    this.res.end();
  }
